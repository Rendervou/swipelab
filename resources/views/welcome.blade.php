...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="hidden sm:flex space-x-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="px-4 py-2 text-white hover:bg-blue-700 rounded-md transition font-medium">Dashboard</a>
                        ...
                        @else
                            <a href="{{ route('login') }}" class="px-4 py-2 text-white hover:bg-blue-700 rounded-md transition font-medium">Login</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="px-4 py-2 bg-white text-blue-600 hover:bg-gray-100 rounded-md transition font-medium">Register</a>
                            @endif
                        @endauth
                    </div>
                </div>
        ...
        <!-- Hero Section -->
        <section class="bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 text-white py-20 sm:py-32">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div class="space-y-6 hero-title">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-4">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="px-8 py-4 bg-white text-blue-600 font-bold rounded-lg hover:bg-gray-100 transition inline-block text-center">
                                    Go to Dashboard →
                                </a>
                            @else
                                <a href="{{ route('register') }}" class="px-8 py-4 bg-white text-blue-600 font-bold rounded-lg hover:bg-gray-100 transition inline-block text-center">
                                    Start for Free →
                                </a>
                                <a href="{{ route('login') }}" class="px-8 py-4 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-400 transition inline-block text-center border-2 border-white">
                                    Sign In
                                </a>
                            @endauth
                        </div>
        ...
        <section class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div class="feature-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 2rem; border-radius: 16px; color: white; box-shadow: 0 8px 20px rgba(102, 126, 234, 0.2);">
                    ...
                    <!-- Feature 2 -->
                    <div class="feature-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 2rem; border-radius: 16px; color: white; box-shadow: 0 8px 20px rgba(245, 87, 108, 0.2);">
                        <div style="font-size: 2.5rem; margin-bottom: 1rem;">👆</div>
                    ...
                    <!-- Feature 3 -->
                    <div class="feature-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 2rem; border-radius: 16px; color: white; box-shadow: 0 8px 20px rgba(79, 172, 254, 0.2);">
                        <div style="font-size: 2.5rem; margin-bottom: 1rem;">🎯</div>
                    ...
                    <!-- Feature 4 -->
                    <div class="feature-card" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 2rem; border-radius: 16px; color: white; box-shadow: 0 8px 20px rgba(250, 112, 154, 0.2);">
                        <div style="font-size: 2.5rem; margin-bottom: 1rem;">🏆</div>
                    ...
                    <!-- Feature 5 -->
                    <div class="feature-card" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); padding: 2rem; border-radius: 16px; color: white; box-shadow: 0 8px 20px rgba(168, 237, 234, 0.2);">
                        <div style="font-size: 2.5rem; margin-bottom: 1rem;">🌟</div>
                        <h3 class="text-xl font-bold mb-3" style="color: #1f2937;">Community</h3>
                    ...
                    <!-- Feature 6 -->
                    <div class="feature-card" style="background: linear-gradient(135deg, #ff9a56 0%, #ff6a88 100%); padding: 2rem; border-radius: 16px; color: white; box-shadow: 0 8px 20px rgba(255, 154, 86, 0.2);">
                        <div style="font-size: 2.5rem; margin-bottom: 1rem;">📊</div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; margin: 0 auto 1.5rem; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: 700;">1</div>
                        <h3 class="font-bold text-lg mb-2">Create Account</h3>
                        <p class="text-gray-600">Sign up free dengan email Anda dalam 30 detik</p>
                    </div>
                    <div class="text-center">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 50%; margin: 0 auto 1.5rem; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: 700;">2</div>
                    ...
                    <div class="text-center">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 50%; margin: 0 auto 1.5rem; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: 700;">3</div>
                    ...
                    <div class="text-center">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); border-radius: 50%; margin: 0 auto 1.5rem; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: 700;">4</div>
